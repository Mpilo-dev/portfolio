...
//         </HeaderContainer>
//         <ContentContainer>
//           <CardsContainer isCardSelected={selectedIdx !== null}>
//             <ButtonWrapper>
//               <ButtonContainer>
...
//             </CardsWrapper>
//           </CardsContainer>
//           <DetailsContainer isCardSelected={selectedIdx !== null}>
//             {isLoading ? (
...
const CardsWrapper = styled.div`
  ...
  @media (max-width: ${breakpoints.tabletSM}px) {
    ...
    scrollbar-color: var(--green-primary) var(--white-primary);
...
const ProjectsPage = () => {
  ...
  React.useEffect(() => {
    if (typeof window !== "undefined") {
      setIsMobile(window.innerWidth <= breakpoints.tabletSM);
      const handleResize = () => {
        setIsMobile(window.innerWidth <= breakpoints.tabletSM);
      };
